...
Query.prototype.find = function(table, criteria) {
  ...
  this._query = utils.buildSelectStatement(criteria, table, false);
...
Query.prototype.count = function(table, criteria) {

  this._query = utils.buildSelectStatement(criteria, table, true);
  if(criteria) this._build(criteria);
 ...
 */
 ...
 Query.prototype.softDestroy = function(table, criteria) {
  this._query = 'UPDATE ' + table + ' SET \"deletedAt\" = NOW() ';
  if (criteria) this._build(criteria);
...
Query.prototype.cast = function(values) {
  ...
  Object.keys(values).forEach(function(key) {
    ...
    // Lookup schema type
    if(!_.has(self._schema, key)) return;
